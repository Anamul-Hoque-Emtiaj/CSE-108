...
class employee: public personalInfo, public departmentInfo
{
    int joining_year;
public:
    employee(char *pName, int eId, char g,char *dName, char* aw, int jYear): personalInfo(pName,eId,g),departmentInfo(dName,aw)
    {
        joining_year=jYear;
    }
    void showEmployeeInfo()
    {
        ...
        cout<<"Showing departmental Information:"<<endl;
        cout<<"Department Name: "<<deptName<<endl;
        cout<<"Assigning work: "<<assignedWork<<endl;
    }
};
...
class serverMaintenanceOfficer: public employee
{
    int perHourSalary;
public:
    serverMaintenanceOfficer(char *pName, int eId, char g, char *dName, char* aw, int jYear, int phSalary): employee(pName, eId, g,dName, aw,jYear)
    {
        perHourSalary=phSalary;
    }
    void showEmployeeInfo()
    {
        cout<<"===Showing details information of employee: "<<name<<"==="<<endl;
        ...
        cout<<"Department Name: "<<deptName<<endl;
        cout<<"Assigning work: "<<assignedWork<<endl;
        cout<<"Per Hour Sallary: "<<perHourSalary<<endl;
    }
};
